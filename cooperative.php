...
<div class="cooperative-page">
    ...
    <?php
    // FIELD VALUES
    $image_1   = get_field('cooperative_page_image');
    $heading_1 = get_field('cooperative_page_heading');
    $text_1    = get_field('cooperative_page_text');

    $image_2 = get_field('cooperative_page_image_2');
    $text_2  = get_field('cooperative_page_text_2');

    $image_3 = get_field('cooperative_page_image_3');
    $text_3  = get_field('cooperative_page_text_3');

    $image_4 = get_field('cooperative_page_image_4');
    $text_4  = get_field('cooperative_page_text_4');
    ?>
