...
?>
<div class="sections-wrapper apply-page">
...
<?php endif; ?>
 ...
 <?php if ($apply_button_text && $external_apply_link) : ?>
            <a href="<?php echo esc_url($external_apply_link); ?>" class="btn yellow-btn btn-margin-bottom" target="_blank" rel="noopener">
                <?php echo esc_html($apply_button_text); ?>
            </a>
        <?php endif; ?>
<?php if ($contact = get_field('apply_page_contact_info')) : ?>
    <div class="apply-contact"><?php echo wp_kses_post($contact); ?></div>
<?php endif; ?>
</div>
